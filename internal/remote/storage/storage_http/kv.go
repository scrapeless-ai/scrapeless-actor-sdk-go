...
func (c *Client) ListNamespaces(ctx context.Context, page int, pageSize int, desc bool) (*KvNamespace, error) {
	body, err := request2.Request(ctx, request2.ReqInfo{
		...
		Url:    fmt.Sprintf("%s/scrapeless/actor/api/v1/kv/namespaces?desc=%v&page=%d&pageSize=%d", config.StorageServiceHost, desc, page, pageSize),
		Body:   "",
...
func (c *Client) CreateNamespace(ctx context.Context, req *CreateKvNamespaceRequest) (string, error) {
	...
	body, err := request2.Request(ctx, request2.ReqInfo{
		...
		Url:    fmt.Sprintf("%s/scrapeless/actor/api/v1/kv/namespaces", config.StorageServiceHost),
		Body:   string(reqBody),
		Headers: map[string]string{
			env.HTTPHeader: config.Token,
		},
...
func (c *Client) GetNamespace(ctx context.Context, namespaceId string) (*KvNamespaceItem, error) {
	body, err := request2.Request(ctx, request2.ReqInfo{
		Method: http.MethodGet,
		Url:    fmt.Sprintf("%s/scrapeless/actor/api/v1/kv/%s", config.StorageServiceHost, namespaceId),
		Headers: map[string]string{
			env.HTTPHeader: config.Token,
		},
	})
...
func (c *Client) RenameNamespace(ctx context.Context, namespaceId string, name string) (bool, error) {
	body, err := request2.Request(ctx, request2.ReqInfo{
		...
		Url:    fmt.Sprintf("%s/scrapeless/actor/api/v1/kv/%s/rename", config.StorageServiceHost, namespaceId),
...
func (c *Client) ListKeys(ctx context.Context, req *ListKeyInfo) (*KvKeys, error) {
	body, err := request2.Request(ctx, request2.ReqInfo{
		Method: http.MethodGet,
		Url:    fmt.Sprintf("%s/scrapeless/actor/api/v1/kv/%s/keys?page=%d&pageSize=%d", config.StorageServiceHost, req.NamespaceId, req.Page, req.Size),
		Headers: map[string]string{
			env.HTTPHeader: config.Token,
		},
	})
...
func (c *Client) GetValue(ctx context.Context, namespaceId string, key string) (string, error) {
	body, err := request2.Request(ctx, request2.ReqInfo{
		Method: http.MethodGet,
		Url:    fmt.Sprintf("%s/scrapeless/actor/api/v1/kv/%s/%s", config.StorageServiceHost, namespaceId, key),
		Headers: map[string]string{
			env.HTTPHeader: config.Token,
		},
	})
...
func (c *Client) BulkSetValue(ctx context.Context, req *BulkSet) (int64, error) {
	...
	body, err := request2.Request(ctx, request2.ReqInfo{
		Method: http.MethodPost,
		Url:    fmt.Sprintf("%s/scrapeless/actor/api/v1/kv/%s/bulk", config.StorageServiceHost, req.NamespaceId),
...
func (c *Client) BulkDelValue(ctx context.Context, namespaceId string, keys []string) (bool, error) {
	...
	body, err := request2.Request(ctx, request2.ReqInfo{
		Method: http.MethodDelete,
		Url:    fmt.Sprintf("%s/scrapeless/actor/api/v1/kv/%s/bulk", config.StorageServiceHost, namespaceId),
